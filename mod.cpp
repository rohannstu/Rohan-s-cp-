...
inline long long modPow(long long b, long long p) { long long r = 1; while(p) { if(p&1LL) r = modMul(r, b); b = modMul(b, b); p >>= 1LL; } return r; }
inline long long modInverse(long long a) { return modPow(a, MOD-2); }  /// When MOD is prime.
